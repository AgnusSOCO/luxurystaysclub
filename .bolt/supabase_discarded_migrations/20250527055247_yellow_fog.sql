/*
  # Fix Penthouse Properties

  1. Changes
    - Remove all existing penthouse properties at the specified address
    - Add back the correct Deer Valley Vista Penthouse
    
  2. Notes
    - Ensures no duplicate properties exist
    - Maintains data consistency
*/

-- Remove all penthouses at this address
DELETE FROM properties 
WHERE location->>'address' LIKE '1134 West Helling Circle%';

-- Add the correct penthouse
