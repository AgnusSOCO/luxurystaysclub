/*
  # Add New Vissen Way Property

  1. Changes
    - Remove any existing property with the same address
    - Add new Vissen Way property with updated details
...
-- First remove any existing property with the same address
