/*
  # Clean up properties and add new townhouse
  
  1. Changes
    - Remove duplicate Vissen Way property
    - Add new townhouse property with updated amenities and details
    
  2. Security
    - No security changes needed
*/

-- First remove the duplicate Vissen Way property
